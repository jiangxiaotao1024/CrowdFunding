...
.seltype {
 ...
 <div class="navbar-wrapper">
    ...
    $(".thumbnail").click(function(){
        ...
        accttype=$(this).attr("value")
    });
    function submit(){
    	var id=${memberLogin.id};
    	$.ajax({
    		type:"post",
    		url:"${APP_PATH}/member/submitAccttype.do",
    		data:{
    			accttype:accttype,
    			id:id
    		},
    		success:function(result){
    			if(result.success){
    				window.location.href="${APP_PATH}/member/info.htm";
    			}else{

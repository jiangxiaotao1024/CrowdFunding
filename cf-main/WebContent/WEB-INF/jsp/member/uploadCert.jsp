 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form id="form" style="margin-top:20px;" method="post" enctype="multipart/form-data">
		<c:forEach items="${certs}" var="cert" varStatus="status">
			...
			<input type="file" name="memberCerts[${status.index }].fileImg" class="form-control" >
            <br>
            <img src="../img/pic.jpg">
		  </div>
		</c:forEach>
        ...
        $("#next").click(function(){
        	var options={
            		...
            		success:function(result){
            			if(result.success){
            				window.location.href="${APP_PATH}/member/email.htm"
            			}else{

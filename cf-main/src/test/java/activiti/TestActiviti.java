...
import cf.activiti.listener.NoListener;
import cf.activiti.listener.YesListener;
...
public class TestActiviti {
	...
	public void test3() {
		...
		System.out.println("******************************");
		// 排序查询流程定义，分页查询流程定义
		ProcessDefinitionQuery processDefinitionQuery2 = processDefinitionQuery.orderByProcessDefinitionVersion()
				.desc();
		List<ProcessDefinition> processDefinitions2 = processDefinitionQuery2.listPage(0, 2);
		for (ProcessDefinition processDefinition2 : processDefinitions2) {
		...
		ProcessDefinition processDefinition2 = processDefinitionQuery.processDefinitionKey("myProcess").latestVersion()
				.singleResult();
		System.out.println("Id=" + processDefinition2.getId());
		System.out.println("Key=" + processDefinition2.getKey());
		System.out.println("Name=" + processDefinition2.getName());
	...
	// 4.启动流程实例
	/**
	 * act_hi_actinst, 历史的活动的任务表. act_hi_procinst, 历史的流程实例表. act_hi_taskinst,
	 * 历史的流程任务表 act_ru_execution, 正在运行的任务表. act_ru_task, 运行的任务数据表.
	 */
	@Test
	public void test4() {
	...
	public void test6() {
		...
		HistoricProcessInstance historicProcessInstance = historicProcessInstanceQuery.processInstanceId("301")
